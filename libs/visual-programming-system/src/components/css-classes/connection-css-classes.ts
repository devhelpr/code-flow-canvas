export const getConnectionCssClasses = () => {
  return {
    ...
    pathCssClasses: `connection-path pointer-events-stroke cursor-pointer`,
    pathDependentCssClasses: `connection-path pointer-events-none line-dependency-conntection`,
