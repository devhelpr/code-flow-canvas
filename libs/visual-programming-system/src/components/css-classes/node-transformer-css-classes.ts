export const getNodeTransformerCssClasses = () => {
  return {
    nodeTransformerClasses: `hidden absolute top-0 left-0 z-[2000] border-[#cccccc] border pointer-events-none rounded`,
    ...
    moveNodesPanelClasses: `absolute -bottom-[48px] left-[50%] flex justify-center items-center origin-bottom w-[96px] h-[32px] -translate-x-[50%] gap-[8px] flex-grow flex-shrink-0`,
