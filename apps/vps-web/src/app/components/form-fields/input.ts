...
export class InputFieldChildComponent extends Component<InputFieldChildProps> {
  oldProps: InputFieldChildProps | null = null;
  input: HTMLInputElement | null = null;
  label: HTMLLabelElement | null = null;
  doRenderChildren = false;
  initialRender = false;
  constructor(parent: BaseComponent | null, props: InputFieldChildProps) {
    super(parent, props);
